...
figure
plot(tspan,mnt2(5:10,:)',t,y(:,5:10)./kron(ones(1,6),y(:,1))*diag(theta),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
...
figure
plot(tspan,mnt2(15:20,:)',t,y(:,11:16)./kron(ones(1,6),y(:,2))*diag(theta),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
...
figure
plot(tspan,mnt2(25:30,:)',t,y(:,17:22)./kron(ones(1,6),y(:,3))*diag(theta),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
...
figure
plot(tspan,mnt2(35:40,:)',t,y(:,23:28)./kron(ones(1,6),y(:,4))*diag(theta),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
...
leg_text = {'$x_{01}$','$x_{02}$','$x_{03}$','$x_{04}$'};
figure
plot(tspan,mnt2(11:14,:)',t,y(:,29:32)./kron(ones(1,4),y(:,1))*diag(x0),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
...
figure
plot(tspan,mnt2(21:24,:)',t,y(:,33:36)./kron(ones(1,4),y(:,2))*diag(x0),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
...
figure
plot(tspan,mnt2(31:34,:)',t,y(:,37:40)./kron(ones(1,4),y(:,3))*diag(x0),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
...
figure
plot(tspan,mnt2(41:44,:)',t,y(:,41:44)./kron(ones(1,4),y(:,4))*diag(x0),'blackx')
title('Morris vs TSF','Interpreter','LaTex','FontSize',20)
xlabel('Time (s)','Interpreter','LaTex','FontSize',20)
ylabel('$\frac{\partial x}{\partial \theta}$','Interpreter','LaTex','FontSize',20)
set(gca,'FontSize',14)
